...
if input_address:
    try:
        ...
        if response.status_code != 200:
            ...
            legend_html = """
                <div style="position: absolute; top: 50%; left: 105%; width: 220px; 
            ...
            slide.placeholders[1].text = f"Generated by: {st.session_state['user_email']}"

            # Map Slide
            slide = prs.slides.add_slide(prs.slide_layouts[5])
            slide.shapes.title.text = "Closest Centres"
            slide.shapes.add_picture(folium_map_path, Inches(1), Inches(1), height=Inches(5.5))

            # Distance slide
            slide = prs.slides.add_slide(prs.slide_layouts[1])
            slide.shapes.title.text = "Distance Details"
            slide.shapes.add_textbox(Inches(1), Inches(1.5), Inches(8), Inches(6)).text = distance_text
            ...
            st.download_button(
                ...
                data=pptx_buffer,
                file_name="closest_centres_map.pptx",
