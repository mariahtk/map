...
if input_address:
    try:
        ...
        if response.status_code != 200:
            ...
            for i, (index, row) in enumerate(closest.iterrows(), start=1):
            ...
            prs.save(ppt_bytes)
            ppt_bytes.seek(0)
            st.download_button("📥 Download PowerPoint", data=ppt_bytes, file_name="Closest_Centres_Presentation.pptx")
